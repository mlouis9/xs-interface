...
.. parsed-literal::
    ...
    {'attributes': ['inf_rabs', 'inf_nsf', 'kappa', 'inf_flx', 'inf_sp0'],
     'dimensions': array([1, 1, 1, 1, 2])}
...
.. code:: 
    ...
    ss0.AddState([600.0, 600, 500], "nom", timePoint=2.5)
    # macro data
...
.. code:: 
    ...
    ss1 = SingleSet(rc, states, fluxName="inf_flx",
                   energyStruct=[10.0E+6, 0.6025, 0.0])
    ss1.AddState([900.0, 600, 500], "nom", timePoint=2.5)
    # macro data
...
.. code:: 
    ...
    ss2 = SingleSet(rc, states, fluxName="inf_flx",
                   energyStruct=[10.0E+6, 0.6025, 0.0])
    ss2.AddState([1200.0, 600, 500], "nom", timePoint=2.5)
    # macro data
