...
reslt.Iterate(
    corrattrs=['topadf'], refFlx=refFlx, newtonIters=10, krylovSpan=13, 
    dampingF=1.0)
...
# Absolute fluxes
flx_g1 = {'Serpent': reslt.refFlxNorm,
          'DYN3D wo/corr': reslt.fluxes[0, :],
          'DYN3D w/corr': reslt.fluxes[-1, :],}
...
# difference in flux
diff_flx_gr1_nocorr =\
    100*(1-(reslt.refFlxNorm/reslt.fluxes[0, :]))
diff_flx_gr1_wcorr =\
    100*(1-(reslt.refFlxNorm/reslt.fluxes[-1, :]))



diff_flx_gr1 = {
          'DYN3D wo/corr': diff_flx_gr1_nocorr,
          'DYN3D w/corr': diff_flx_gr1_wcorr,}



plt.figure()
Plot1d(xvalues=zmid, yvalues=diff_flx_gr1, 
       markers=['*', 'o'],
       xlabel="Height, cm", ylabel="Percent difference in fast flux, %")
